...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            new Kitap("Nesneye Yönelik Programlama", "Arzu Kilitci CALAYIR", 440, 100),
            new Kitap("Veri Yapıları Ve Algoritma Analizi", "Ümit ÖZTÜRK", 375, 50),
            new Kitap("Mantıksal Tasarım", "Mustafa YAĞIMLI", 350, 30),
            new Kitap("Diferansiyel Denklemler", "Pega MUTLU", 200, 20),
        };
